...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		btnNewButton.addActionListener((ActionEvent e)->{dispose();});
		...
		btnNewButton_1.setRolloverIcon(new ImageIcon(Menu.class.getResource("/images/accueil/Settings-02-128-actif.png")));
